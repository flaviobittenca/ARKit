...
class Gesture {
    ...
    let objectManager: VirtualElementManager
	...
	init(_ touches: Set<UITouch>, _ sceneView: ARSCNView, _ lastUsedObject: VirtualElement?, _ objectManager: VirtualElementManager) {
    ...
    static func startGestureFromTouches(_ touches: Set<UITouch>, _ sceneView: ARSCNView, _ lastUsedObject: VirtualElement?, _ objectManager: VirtualElementManager) -> Gesture? {
		if touches.count == 1 {
