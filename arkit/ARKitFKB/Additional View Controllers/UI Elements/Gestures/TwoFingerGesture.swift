...
class TwoFingerGesture: Gesture {
    ...
    var firstTouchWasOnObject: VirtualElement?
    ...
    override init(_ touches: Set<UITouch>, _ sceneView: ARSCNView, _ lastUsedObject: VirtualElement?, _ objectManager: VirtualElementManager) {
        ...
        for result in hitTestResults {
            let object = VirtualElement.isNodePartOfVirtualObject(result.node)
            if object != nil {
    ...
    func updateTranslation(of virtualObject: VirtualElement, midpoint: CGPoint) {
    ...
    func updateRotation(of virtualObject: VirtualElement, span: CGPoint) {
    ...
    func updateScaling(of virtualObject: VirtualElement, span: CGPoint) {
